...
A convenience wrapper around [encrypt](encrypt.md) that serializes the resulting message into a secure, checksummed Base58 string suitable for immediate network transmission or storage.

#### Return

A `Result` containing the Base58-encoded string representation of the encrypted message.
