...
| Name | Summary |
|---|---|
| [Kodium](-kodium/index.md) | [common]<br>object [Kodium](-kodium/index.md)<br>Kodium is a cryptographic utility object for key pair generation, encryption, and decryption. It supports both asymmetric and symmetric encryption methods, allowing for secure communication and data storage. Encoded data is managed using Base58 encoding with checksum for integrity verification. |
