//[kodium](../../../index.md)/[io.kodium](../index.md)/[Kodium](index.md)/[decodeArrayFromString](decode-array-from-string.md)

# decodeArrayFromString
...
A Result containing the decoded byte array if successful, or the error if decoding fails.
