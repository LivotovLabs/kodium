...
Signs data using the classical Ed25519 component of the PQC Private Key. Returns the detached signature as a Base58 encoded string. Note: This signature is purely classical (Ed25519) as PQC signatures (e.g. ML-DSA) are not yet integrated.
