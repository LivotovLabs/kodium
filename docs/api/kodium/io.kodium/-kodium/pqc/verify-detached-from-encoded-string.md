...
[common]\
fun [verifyDetachedFromEncodedString](verify-detached-from-encoded-string.md)(theirPublicKey: [KodiumPqcPublicKey](../../-kodium-pqc-public-key/index.md), data: [ByteArray](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin-stdlib/kotlin/-byte-array/index.html), signatureB58: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin-stdlib/kotlin/-string/index.html)): [Boolean](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin-stdlib/kotlin/-boolean/index.html)
