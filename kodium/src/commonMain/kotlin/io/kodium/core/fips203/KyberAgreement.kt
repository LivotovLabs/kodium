...
import io.kodium.core.fips203.KyberDecryptionKey
import io.kodium.core.fips203.KyberEncapsulationKey
import io.kodium.core.fips203.KyberEncapsulationResult
import io.kodium.core.fips203.KyberEncryptionKey
...
internal object KyberAgreement {
    ...
    internal fun decapsulate(decapsulationKey: KyberDecapsulationKey, kyberCipherText: KyberCipherText): ByteArray {
        ...
        val secretKeyRejectionFull = ByteArray(64)
        SHAKE256().apply {
            update(decapsulationKey.randomSeed)
            update(kyberCipherText.fullBytes)
        }.digestInto(secretKeyRejectionFull, 0)
        val secretKeyRejection = secretKeyRejectionFull.copyOfRange(0, KyberConstants.SECRET_KEY_LENGTH)
